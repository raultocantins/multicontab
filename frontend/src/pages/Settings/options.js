              ...
              control={
                <IOSSwitch
                  checked={
                    settings &&
                    settings.length > 0 &&
                    getSettingValue("allTicket") === "enabled"
                  }
                  onChange={handleChangeBooleanSetting}
                  name="allTicket"
                />
              ...
              control={
                <IOSSwitch
                  checked={
                    settings &&
                    settings.length > 0 &&
                    getSettingValue("closeTicketApi") === "enabled"
                  }
                  onChange={handleChangeBooleanSetting}
                  name="closeTicketApi"
                />
              ...
              control={
                <IOSSwitch
                  checked={
                    settings &&
                    settings.length > 0 &&
                    getSettingValue("darkMode") === "enabled"
                  }
                  onChange={handleChangeBooleanSetting}
                  name="darkMode"
                />
              ...
              control={
                <IOSSwitch
                  checked={
                    settings &&
                    settings.length > 0 &&
                    getSettingValue("created") === "enabled"
                  }
                  onChange={handleChangeBooleanSetting}
                  name="created"
                />
          ...
          <Paper className={classes.paper} elevation={3}>
            ...
            >
              ...
              <option value="1296000">
                {i18n.t(
                  "settings.settings.timeCreateNewTicket.options.1296000"
                )}
              </option>
              <option value="2592000">
                {i18n.t(
                  "settings.settings.timeCreateNewTicket.options.2592000"
                )}
              </option>
            </Select>
          </Paper>
